        ...
        for chunk_path in self.chunks:
            ...
            for example in chunk:
                ...
                try:
                    ...
                    print("Skipped because of not enough frames.")
                    continue

                # Skip the example if the field of view is too wide.
                if (get_fov(intrinsics).rad2deg() > self.cfg.max_fov).any():
                    print(
                        f"Skipped {scene} because of too wide field of view: "
                        f"{get_fov(intrinsics).rad2deg()}"
                    )
                    continue
                ...
                print("context_images.shape: ", context_images.shape, context_image_invalid)
                print("target_images.shape: ", target_images.shape, target_image_invalid)
